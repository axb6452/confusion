...
import { Breadcrumb, BreadcrumbItem, Card, CardBody, CardHeader, CardImg, CardText, CardTitle, CardSubtitle, Media } from 'reactstrap';
            ...
            <div className="row card" style={{ "border": "none" }}>
                <Card style={{ "border": "none" }}>
                    ...
                    <div className="row card-body">
                        <Fade in>
                        <CardImg src={baseUrl + leader.image} left height={115} className="col-sm-2 m-4"></CardImg>
